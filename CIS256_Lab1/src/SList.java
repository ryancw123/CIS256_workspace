...
public class SList {
  ...
  /*
   * InsertFront had to be modified in order to keep track of tail if the list is empty
   */
  public void insertFront(Object obj) {
	if (head == null) {
	   head = new SListNode(obj);
	   tail = head;//Both head and tail point to the same node at the start
	}else {
   ...
   **/
  /*
   * I had to change the head to reference the tail when there is nothing in the list
   * instead of looping to the last node, I changed the tail when an object is inserted to the end.
   * insertFront also had to be modified.
   */
  public void insertEnd(Object obj) {
    if (tail == null) {
    	tail = new SListNode(obj);
    	head = tail;//Both head and tail point to the same node at the start
    } else {
